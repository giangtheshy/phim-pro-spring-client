...
export const createFilm = (film) => async (dispatch) => {
  try {
    ...
    dispatch({ type: types.CREATE_FILM, payload: data });
  } catch (error) {
    console.log(error);
  }
};
export const getFilms = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: types.GET_FILMS, payload: data });
  } catch (error) {
    console.log(error);
  }
};
export const updateFilm = (film) => async (dispatch) => {
  try {
    const { data } = await api.updateFilm(film);
    dispatch({ type: types.UPDATE_FILM, payload: data });
  } catch (error) {
    console.log(error);
  }
};
export const removeFilm = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: types.REMOVE_FILM, payload: id });
  } catch (error) {
    console.log(error);
  }
};
...
export const setIsEdit = (id) => async (dispatch) => {
  try {
    dispatch({ type: types.SET_IS_EDIT, payload: id });
  } catch (error) {
    console.log(error);
  }
};
...
export const getWatched = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: types.GET_WATCHED, payload: data });
  } catch (error) {
    console.log(error);
  }
};
